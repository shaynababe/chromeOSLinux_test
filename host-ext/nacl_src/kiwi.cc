 ...
 *
 * This is a NaCl module, used by the chromeOSLinux extension, to provide
 * a display for chromeOSLinux-in-a-tab.
 * On one end, it communicates with the Javascript module window.js, on the
 * other, it requests, via WebSocket, frames from chromeOSLinuxfbserver, and sends
 * inputs events.
 *
 */
